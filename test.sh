...
dotnet test test/integration/csharp /p:Exclude="[xunit*]*" /p:CollectCoverage=true /p:MergeWith='../../unit/csharp/coverage.json' /p:CoverletOutputFormat=json /p:CoverletOutput='coverage.json'
dotnet test test/integration/fsharp /p:Exclude="[xunit*]*" /p:CollectCoverage=true /p:MergeWith='../csharp/coverage.json' /p:CoverletOutputFormat=lcov /p:CoverletOutput='../../../coverage.lcov'
