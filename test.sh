...
dotnet test test/integration /p:Exclude="[xunit*]*" /p:CollectCoverage=true /p:MergeWith='../unit/csharp/coverage.json' /p:CoverletOutputFormat=lcov /p:CoverletOutput='../../coverage.lcov'
