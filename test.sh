...
dotnet test CogniteSdk/test/csharp /p:Exclude="[xunit*]*" /p:CollectCoverage=true /p:MergeWith='../csharp/coverage.json' /p:CoverletOutputFormat=lcov /p:CoverletOutput='../../../coverage.lcov'
