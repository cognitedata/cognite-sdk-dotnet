...
module Labels =
    ...
    let list (query: LabelQuery) (source: HttpHandler<unit>) : HttpHandler<ItemsWithCursor<Label>> =
        source |> withLogMessage "Labels:get" |> list query Url
