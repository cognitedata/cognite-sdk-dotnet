...
namespace CogniteSdk.Resources
{
    ...
    public class ThreeDModelsResource : Resource
    {
        ...
        internal ThreeDModelsResource(Func<CancellationToken, Task<string>> authHandler, FSharpFunc<IAsyncNext<HttpContext, Unit>, Task<Unit>> ctx) : base(authHandler, ctx)
        {
        }
