...
namespace CogniteSdk.Resources
{
    ...
    public class RelationshipResource : Resource
    {
        ...
        internal RelationshipResource(Func<CancellationToken, Task<string>> authHandler, FSharpFunc<IAsyncNext<HttpContext, Unit>, Task<Unit>> ctx) : base(authHandler, ctx)
        {
        }
