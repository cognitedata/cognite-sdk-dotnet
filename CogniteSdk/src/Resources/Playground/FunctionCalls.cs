...
namespace CogniteSdk.Resources.Playground
{
    ...
    public class FunctionCallResource : Resource
    {
        ...
        internal FunctionCallResource(Func<CancellationToken, Task<string>> authHandler, FSharpFunc<IAsyncNext<HttpContext, Unit>, Task<Unit>> ctx) : base(authHandler, ctx)
        {
        }
