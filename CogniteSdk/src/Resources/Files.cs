...
{
    /// <summary>
    /// Contains all the client methods for handling <see href="https://docs.cognite.com/api/v1/#tag/Files">Files</see>.
    /// You need to access the methods in this class through <see cref="Client.Files" /> property of the <see
    /// cref="Client" />.
    /// </summary>
