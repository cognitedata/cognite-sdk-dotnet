...
namespace CogniteSdk.Resources
{
    ...
    public class DataModelsResource : Resource
    {
        ...
        {
            var req = Oryx.Cognite.DataModels.upsertSpaces(spaces, GetContext(token));
        ...
        {
            var req = Oryx.Cognite.DataModels.listSpaces(query, GetContext(token));
            return await RunAsync(req).ConfigureAwait(false);
        }
        ...
        {
            var req = Oryx.Cognite.DataModels.retrieveSpaces(ids, GetContext(token));
            return await RunAsync(req).ConfigureAwait(false);
        }
        ...
        {
            var req = Oryx.Cognite.DataModels.deleteSpaces(ids, GetContext(token));
            return await RunAsync(req).ConfigureAwait(false);
        }
        ...
        {
            var req = Oryx.Cognite.DataModels.upsertDataModels(dataModels, GetContext(token));
            return await RunAsync(req).ConfigureAwait(false);
        }
        ...
        {
            var req = Oryx.Cognite.DataModels.listDataModels(query, GetContext(token));
            return await RunAsync(req).ConfigureAwait(false);
        }
        ...
        {
            var req = Oryx.Cognite.DataModels.filterDataModels(filter, GetContext(token));
            return await RunAsync(req).ConfigureAwait(false);
        }
        ...
        {
            var req = Oryx.Cognite.DataModels.retrieveDataModels(ids, inlineViews, GetContext(token));
            return await RunAsync(req).ConfigureAwait(false);
        }
        ...
        {
            var req = Oryx.Cognite.DataModels.deleteDataModels(ids, GetContext(token));
            return await RunAsync(req).ConfigureAwait(false);
        }
        ...
        {
            var req = Oryx.Cognite.DataModels.upsertViews(views, GetContext(token));
            return await RunAsync(req).ConfigureAwait(false);
        }
        ...
        {
            var req = Oryx.Cognite.DataModels.listViews(query, GetContext(token));
            return await RunAsync(req).ConfigureAwait(false);
        }
        ...
        {
            var req = Oryx.Cognite.DataModels.retrieveViews(ids, includeInheritedProperties, GetContext(token));
            return await RunAsync(req).ConfigureAwait(false);
        }
        ...
        {
            var req = Oryx.Cognite.DataModels.deleteViews(ids, GetContext(token));
            return await RunAsync(req).ConfigureAwait(false);
        }
        ...
        {
            var req = Oryx.Cognite.DataModels.upsertContainers(containers, GetContext(token));
            return await RunAsync(req).ConfigureAwait(false);
        }
        ...
        {
            var req = Oryx.Cognite.DataModels.listContainers(query, GetContext(token));
            return await RunAsync(req).ConfigureAwait(false);
        }
        ...
        {
            var req = Oryx.Cognite.DataModels.retrieveContainers(ids, GetContext(token));
            return await RunAsync(req).ConfigureAwait(false);
        }
        ...
        {
            var req = Oryx.Cognite.DataModels.deleteContainers(ids, GetContext(token));
            return await RunAsync(req).ConfigureAwait(false);
        }
        ...
        {
            var req = Oryx.Cognite.DataModels.upsertInstances(request, GetContext(token));
            return await RunAsync(req).ConfigureAwait(false);
        }
        ...
        {
            var req = Oryx.Cognite.DataModels.filterInstances<T>(filter, GetContext(token));
            return await RunAsync(req).ConfigureAwait(false);
        }
        ...
        {
            var req = Oryx.Cognite.DataModels.retrieveInstances<T>(query, GetContext(token));
            return await RunAsync(req).ConfigureAwait(false);
        }
        ...
        {
            var req = Oryx.Cognite.DataModels.searchInstances<T>(query, GetContext(token));
            return await RunAsync(req).ConfigureAwait(false);
        }
        ...
        {
            var req = Oryx.Cognite.DataModels.aggregateInstances(query, GetContext(token));
            return await RunAsync(req).ConfigureAwait(false);
        }
        ...
        {
            var req = Oryx.Cognite.DataModels.deleteInstances(ids, GetContext(token));
            return await RunAsync(req).ConfigureAwait(false);
        }
        ...
        {
            var req = Oryx.Cognite.DataModels.queryInstances<T>(query, GetContext(token));
            return await RunAsync(req).ConfigureAwait(false);
        }
