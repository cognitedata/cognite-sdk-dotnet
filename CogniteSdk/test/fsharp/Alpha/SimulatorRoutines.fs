...
let ``Create simulator routine revisions is Ok`` () =
    task {
        ...
        try
            ...
            let inputs = [ SimulatorRoutineRevisionInput(Name = "test_input", ReferenceId = "test_input") ]
            let outputs = [ SimulatorRoutineRevisionOutput(Name = "test_output", ReferenceId = "test_output") ]
